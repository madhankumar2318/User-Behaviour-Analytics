...
class AuditLogger:
    ...
    def log_action(self, user_id, username, action, resource=None, details=None, ip_address=None):
        """
        Log user action
    ...
    def log_user_action(self, user_id, username, action_type, target_user_id=None, ip_address=None):
        """
    ...
    def log_data_access(self, user_id, username, resource_type, resource_id=None, ip_address=None):
        """
        Log data access
        ...
        resource = f"{resource_type.lower()}:{resource_id}" if resource_id else resource_type.lower()
    ...
    def get_all_activity(self, action_filter=None, start_date=None, end_date=None, limit=100, offset=0):
        """
