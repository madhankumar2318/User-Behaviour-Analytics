...
class RiskThresholdManager:
    ...
    def init_table(self):
        ...
        defaults = [
            ...
            (None, 'critical_risk', 90, 1, json.dumps(['email', 'sms', 'slack', 'teams'])),
    ...
    def get_threshold(self, threshold_type, user_id=None):
        ...
        if user_id:
            ...
            ''', (user_id, threshold_type)).fetchone()
        ...
        ''', (threshold_type,)).fetchone()
        
        conn.close()
        return dict(result) if result else None
    
    def set_threshold(self, threshold_type, threshold_value, user_id=None, 
                     notification_enabled=True, notification_channels=None):
        ...
        conn.execute('''
            ...
            (user_id, threshold_type, threshold_value, notification_enabled, notification_channels)
            VALUES (?, ?, ?, ?, ?)
        ''', (user_id, threshold_type, threshold_value, 
